...
public class PoolTable extends Actor {
    JWavefrontObject model;
    Matrix4 modelMatrix;

    public PoolTable(float x, float y, float z) {
        super(x, y, z);
        setSize(1.1f, 1, 1.13f);
    }
    ...
    public void init(GL3 gl, Shader shader) {
        model = new JWavefrontObject(new File("./data/table/PoolTable.obj"));
